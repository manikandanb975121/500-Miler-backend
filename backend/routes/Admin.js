...
router.get('', (req, res, next) => {
    ...
    res.status(200)
        .json({
            message: 'Admin Page get Successfully'
        });
});
    ...
    .then(hash => {
        ...
        .then((admin) => {
            ...
            var mailOptions = {
                ...
                to: `${req.body.mail_id}`,
                subject: '500 Miler Email Confirmation',
                                 ...
                                 <tr style="border-collapse:collapse"> 
                                  <td align="center" valign="top" style="padding:0;Margin:0;width:600px"> 
                                   <table width="100%" cellspacing="0" cellpadding="0" background="https://images.theconversation.com/files/312387/original/file-20200129-92992-aoyptf.jpg?ixlib=rb-1.1.0&amp;q=45&amp;auto=format&amp;w=1200&amp;h=1200.0&amp;fit=crop" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-image:url(https://images.theconversation.com/files/312387/original/file-20200129-92992-aoyptf.jpg?ixlib=rb-1.1.0&amp;q=45&amp;auto=format&amp;w=1200&amp;h=1200.0&amp;fit=crop);background-repeat:no-repeat;background-position:left top" role="presentation"> 
                                     <tr style="border-collapse:collapse"> 
                                      <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="https://www.insidesport.co/wp-content/uploads/2020/07/Global-track-and-field-stars-form-Athletics-Association-to-look-after-the-interest-of-athletes.jpg" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="596"></td> 
                                     </tr> 
                                   </table></td> 
                                 </tr> 
                               </table></td> 
                                 ...
                                 <tr style="border-collapse:collapse"> 
                                  <td align="left" style="padding:0;Margin:0;width:518px"> 
                                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                                     ...
                                     <tr style="border-collapse:collapse"> 
                                      <td class="es-m-txt-c" align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:28px;font-style:normal;font-weight:normal;color:#474745">Your Mail Id, ${req.body.mail_id}</h2></td> 
                                     </tr> 
                                     <tr style="border-collapse:collapse"> 
                                      <td class="es-m-txt-c" align="center" style="padding:0;Margin:0;padding-top:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:19px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:29px;color:#474745">You're almost done with registering on 500 Miler.<br>By clicking on the following button, you are confirming your email address.</p></td> 
                                     </tr> 
                                     <tr style="border-collapse:collapse"> 
...
router.post('/login', (req, res, next) => {
  ...
  let fetchUser;
  Admin.findOne({mail_id: req.body.mail_id})
    .then(user => {
      if (!user) {
    ...
    .then((result) => {
      ...
      const token = jwt.sign(
        { email_id: fetchUser.mail_id, userId: fetchUser._id},
        'secret_this_should_be_longer',
        { expiresIn: '1h'}
      );

      if (fetchUser.isVerified === true) {
        res.status(200).json({
          token: token,
          expiresIn: 3600,
...
router.post('/confirmation', (req, res, next) => {
  ...
  userData = { email: decodedToken.mailId, userId: decodedToken.userId }
  console.log(userData);
  // College.findById(userData.userId).then((user) => {

  // });

  Admin.updateOne({ _id: userData.userId},
      { $set: {'isVerified': true}}).then(user => {
